...
- **`bridge/td_mcp_agent.py`** — td_mcp_agent — run an autonomous building agent directly inside TouchDesigner.
...
- **`td_mcp.egg-info/PKG-INFO`** — Generated data artifact (16,484 bytes) — produced by the build/eval pipeline; not hand-edited.
